 ...
 *
 **/
public class JoinDemoAsyncIoMysql {
    public static void main(String[] args) throws Exception {

        StreamExecutionEnvironment env = StreamExecutionEnvironment.getExecutionEnvironment();
        DataStream<Tuple2<String, String>> textStream = env.socketTextStream("localhost", 9999, "\n")
                .map(p -> {
                    //输入格式为：user,1000,分别是用户名称和城市编号
                    String[] list = p.split(",");
                    return new Tuple2<String, String>(list[0], list[1]);
                })
                .returns(new TypeHint<Tuple2<String, String>>() {
                });


        DataStream<Tuple3<String,String, String>> orderedResult = AsyncDataStream
                //保证顺序：异步返回的结果保证顺序，超时时间1秒，最大容量2，超出容量触发反压
                .orderedWait(textStream, new JoinDemo3AyncFunction(), 1000L, TimeUnit.MILLISECONDS, 2)
                .setParallelism(1);

        DataStream<Tuple3<String,String, String>> unorderedResult = AsyncDataStream
    ...
    static class JoinDemo3AyncFunction extends RichAsyncFunction<Tuple2<String, String>, Tuple3<String, String, String>> {
        // 链接
        ...
        public void open(Configuration parameters) throws Exception {
            ...
            ps = conn.prepareStatement("select name from test.user where id = ?");
        }
        ...
        public void asyncInvoke(Tuple2<String, String> input, ResultFuture<Tuple3<String, String, String>> resultFuture) throws Exception {
            ...
            List list = new ArrayList<Tuple2<String, String>>();
        ...
        //超时处理
        @Override
        public void timeout(Tuple2<String, String> input, ResultFuture<Tuple3<String,String, String>> resultFuture) throws Exception {
            List list = new ArrayList<Tuple2<String, String>>();
